...
//
//      PostListObject postListObject = new PostListObject(document.getString("title"),document.getString("price"),document.getString("description"),document.getString("email"));
//
//
